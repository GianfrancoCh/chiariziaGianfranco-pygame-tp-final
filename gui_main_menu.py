...
class FormMainMenu(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active,path_bg):
        ...
        self.boton_play = Button(master=self,x=250,y=HEIGHT - 300,w=150,h=150,color_background=None,color_border=None,image_background="assets/gui/menu/play.png",on_click=self.on__click_boton_play,on_click_param="form_levels",text=None,font="DroidSerif",font_size=30,font_color=WHITE)

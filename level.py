...
class FormGameLevel1(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active,path_bg):
        ...
        if self.flag_nivel:
            ...
            self.grupo_objetos.add(*self.floor,*self.wall,*self.wall_der,*self.grupo_enemigos,*self.grupo_frutas,self.flag,self.fire,*self.grupo_plataformas)
    ...
    def update(self, lista_eventos,keys,delta_ms):
        ...
        if self.pausado:
            ...
            window.blit(draw_text, (WIDTH/2, HEIGHT/2))

...
class FormSettings(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active,path_bg):
        ...
        self.label_settings = Label(master=self,x=150,y=100,w=WIDTH-250,text="SETTINGS",color_border=None,font="DroidSerif",font_size=50,font_color=BLACK)
        ...
        self.lista_widget = [self.label_settings,self.txt_sound,self.boton_on,self.boton_go_back]
    ...
    def on_click_sound_off(self, parametro):
        ...
        self.change_state_button(self.boton_off, self.boton_on)
